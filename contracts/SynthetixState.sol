...
contract SynthetixState is Owned, State, ISynthetixState {
     ...
     */
    function setCurrentIssuanceData(address account, uint256 initialDebtOwnership) external onlyAssociatedContract {
     ...
     */
    function appendDebtLedgerValue(uint256 value) external onlyAssociatedContract {
