...
contract EmptyCollateralManager is ICollateralManager {
    ...
    // State information
    function long(bytes32) external view returns (uint256 amount) {
        return 0;
    }

    function short(bytes32) external view returns (uint256 amount) {
        return 0;
    }
    ...
    function getShortRate(bytes32) external view returns (uint256 shortRate, bool rateIsInvalid) {
        return (0, false);
    }

    function getRatesAndTime(uint256)
        external
        view
        returns (
            uint256 entryRate,
    ...
    function getShortRatesAndTime(bytes32, uint256)
        external
        view
        returns (
            uint256 entryRate,
    ...
    function exceedsDebtLimit(uint256, bytes32) external view returns (bool canIssue, bool anyRateIsInvalid) {
        return (false, false);
    }
    ...
    // State mutative
    function updateBorrowRates(uint256) external {}

    function updateShortRates(bytes32, uint256) external {}

    function incrementLongs(bytes32, uint256) external {}

    function decrementLongs(bytes32, uint256) external {}

    function incrementShorts(bytes32, uint256) external {}

    function decrementShorts(bytes32, uint256) external {}
}
