...
contract MintableSynthetix is BaseSynthetix {
    ...
    function mintSecondary(address account, uint256 amount) external onlyBridge {
    ...
    function burnSecondary(address account, uint256 amount) external onlyBridge systemActive {
